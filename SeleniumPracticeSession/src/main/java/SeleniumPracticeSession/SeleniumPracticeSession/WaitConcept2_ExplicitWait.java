...
public class WaitConcept2_ExplicitWait {
...
//6.WebDriverWait is applied on a certain element with defined expected condition and time. 
//This wait is only applied to the specified element. This wait can also throw an exception when an element is not found.
